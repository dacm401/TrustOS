// MWT-6 — Memory Governance v0 types.
//
// Deterministic governance metadata + evaluation semantics for memory records.
// Goal: memory becomes traceable, scope-aware, source-aware, retention-aware,
// sensitivity-aware, and linkable to Trust Spine artifacts (evidence / approval
// / review) — instead of opaque context accumulation.
//
// No backend. No network. No enforcement. Pure deterministic functions.
// "Unknown / missing" metadata is NEVER treated as safe.
...
export type MemoryScope =
  ...
  | "project"
  | "system"
  // Anything not in the explicit set below collapses to an invalid/unknown marker.
  | (string & {});
